...
@When("Enter the Account Name as Geetha Mohan")
public void enter_the_account_name_as_geetha_mohan() {
    // Write code here that turns the phrase above into concrete actions
	driver.findElement(By.xpath("//label[text()='Account Name']/following::input")).sendKeys("Geetha Mohan");
    //throw new io.cucumber.java.PendingException();
}
...
public void check_account_name() {
	...
	if(AccountName.equalsIgnoreCase("geetha Mohan"))
